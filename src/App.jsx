...
// ВАЖНО: Замените этот URL на ваш реальный Railway-домен бэкенда
// Пример: https://happyfarms-production.up.railway.app
const API_BASE_URL = 'https://happyfarms-production.up.railway.app';
